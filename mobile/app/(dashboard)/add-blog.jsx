        ...
        >
          ...
          >
            ...
            <View style={styles.section}>
              ...
              <Text style={styles.label}>
                Blog Type <Text style={styles.required}>*</Text>{" "}
              </Text>
              ...
              >
                <Text style={styles.selectText}>
                  {blogTypes.find((item) => item.value === blogType)?.label}
                </Text>
              ...
              <Text style={styles.label}>
                Blog Category <Text style={styles.required}>*</Text>{" "}
              </Text>
              ...
              >
                ...
                >
                  {blogCategory
                    ? blogCategories.find((item) => item.value === blogCategory)
                        ?.label
              ...
              <Text style={styles.label}>
                Blog Date <Text style={styles.required}>*</Text>{" "}
              </Text>
              ...
              >
                ...
                <Text
                  style={[styles.dateText, !blogDate && styles.placeholderText]}
                >
            ...
            <View style={styles.overlay}>
              <View style={styles.modal}>
                <View style={styles.modalHeader}>
                  <Text style={styles.modalTitle}>Select Blog Type</Text>
          ...
          {showCategoryPicker && (
            <View style={styles.overlay}>
              <View style={styles.modal}>
                <View style={styles.modalHeader}>
                  <Text style={styles.modalTitle}>Select Blog Category</Text>
