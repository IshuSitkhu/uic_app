import { StyleSheet, Text, View, ScrollView, TouchableOpacity, ActivityIndicator, Pressable, ImageBackground,} from 'react-native'
                        ...
                        <Pressable style={styles.inspirationCard}>
                            ...
                            <View style={styles.inspirationTextContainer}>
                                ...
                                <View style={styles.blogTopRow}>
                                    ...
                                    <Pressable style={styles.saveButton}>
                                        <Fontisto name="favorite" size={18} color={COLORS.primary} />
                                    </Pressable>
