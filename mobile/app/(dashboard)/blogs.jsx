import { StyleSheet, Text, View, ScrollView, TouchableOpacity, ActivityIndicator, Pressable, Image,} from 'react-native'
    ...
    <>
        <View style={styles.screen}>
            <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.content}>
                ...
                <TouchableOpacity style={styles.addBlog}  onPress={() => router.push("/add-blog")} >
                          <Text style={styles.addBlogText}>
                            Add Blogs
                          </Text>
